...
let result = (number1 === 8 || number2 === 8 || number1 + number2 === 8 || number1 - number2 === 8 || number2 - number1 === 8);
console.log (result)
...
let discountAmount = totalShoppingCart * discountPercentage;
let totalAfterDiscount = totalShoppingCart - discountAmount;

if (totalAfterDiscount > 50) {
    shippingCost = 0; 
}

let totalToCharge = totalAfterDiscount + shippingCost;

console.log ("Totale da addebitare: €" + totalToCharge.toFixed(2));
...
//ho inserito la risposta modificata nella domanda sopra 
